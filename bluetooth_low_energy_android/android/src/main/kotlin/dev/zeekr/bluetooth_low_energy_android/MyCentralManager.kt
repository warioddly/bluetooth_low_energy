...
class MyCentralManager(context: Context, binaryMessenger: BinaryMessenger) : MyBluetoothLowEnergyManager(context),
    ...
    override fun writeCharacteristic(
        ...
        hashCodeArgs: Long,
        valueArgs: ByteArray,
        typeArgs: MyGATTCharacteristicWriteTypeArgs,
    ...
    fun onScanResult(result: ScanResult) {
        ...
        mDevices[addressArgs] = device
        mAPI.onDiscovered(peripheralArgs, rssiArgs, txPowerArgs, advertisementArgs) {}
    }
